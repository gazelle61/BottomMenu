...
public class menu_Tabung extends AppCompatActivity {
    TextView judul;
    EditText jari1;
    EditText jari2;
    EditText tinggi;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.menu_tabung);
        ...
        Button btnKeluar = findViewById(R.id.btnKeluar8);
    ...
    private void  hitungLuasTabung(){
        ...
        if(!jari1Str.isEmpty() && !jari2Str.isEmpty() && !tinggiStr.isEmpty()){
            ...
            double luas = Math.PI * jari1 * jari2 * tinggiValue;
